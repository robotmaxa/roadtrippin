...
<thead><tr><th></th><th>Codex</th><th>Claude Code</th><th>My project</th></tr></thead>
<tbody>
<tr><td>Search structure</td><td>DFS + backtracking</td><td>DFS + branch and bound</td><td>DP over (night, region)</td></tr>
<tr><td>Worst-case cost</td><td>O(n² + nᵏ)</td><td>~6 billion paths</td><td>O(nights · n²)</td></tr>
<tr><td>Exact optimum</td><td>Not originally</td><td>yes</td><td>yes</td></tr>
<tr><td>Lines of code</td><td>~315 + ~180 tests</td><td>709 + 119 tests</td><td>528</td></tr>
<tr><td>Road factor</td><td>1.00 (great-circle)</td><td>1.18 (self-chosen)</td><td>1.25 (specified)</td></tr>
<tr><td>Min daily mileage</td><td>none</td><td>50 mi, unprompted</td><td>50 mi, by measured sweep (originally 100)</td></tr>
<tr><td>Own tests</td><td>43 assertions</td><td>474 assertions</td><td>brute-force diff harness, and manual test files</td></tr>
<tr><td>Considered DP?</td><td>no; justified skipping it</td><td>&ldquo;I never considered it&rdquo;</td><td>chose it deliberately</td></tr>
</tbody></table></div>
<div class="table-scroll"><table>
...
<tr><td>31 (Codex's dataset size)</td><td>13,253,058,000</td><td>6,727</td><td>1,970,129×</td></tr>
...
<tr><td>trip14 ROADTRIP</td><td>no route</td><td>4.79</td></tr>
<tr><td>trip14 OPTLOOP</td><td>2732.12</td><td>2732.12</td></tr>
<tr><td>generated instances solvable</td><td>6 / 25</td><td>6 / 25</td></tr>
</tbody></table></div>
...
<tbody>
<tr><td>4 days</td><td>63.0</td><td>1,115</td></tr>
<tr><td>5 days</td><td>78.2</td><td>1,157</td></tr>
<tr><td>6 days</td><td>93.4</td><td>1,224</td></tr>
<tr><td>7 days (chosen)</td><td>108.5</td><td>1,297</td></tr>
</tbody></table></div>
  ...
  comparison: {
    ...
    main: {
      ...
      rows: [
        ...
        ["Worst-case cost", "O(nights · n²)", "~6 billion paths", "O(n² + nᵏ)", "P(n,7)"],
        ["Exact optimum", "yes — verified by brute force", "yes", "not originally", "yes (own objective)"],
        ...
        ["Considered DP?", "chose it deliberately", "\u201cI never considered it\u201d", "justified skipping it", "no — input scope"],
      ],
    },
    results: {
    ...
    scaling: {
      ...
      rows: [
        ...
        ["31 — Codex's dataset", "13,253,058,000", "6,727", "1,970,129×"],
