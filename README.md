...
Given a fixed route (e.g., Denver to San Francisco) with candidate campsites at known positions with known ratings scaled, select overnight stops such that:
